...
Send files and notes privately between your own devices.

This is the description already present in the accepted 0.5.2 manifest.
...
GOOD TO KNOW
RelayDrop is for your own devices, not conversations with other people. It does not provide push notifications or sync while the sidebar is closed. Files are limited to 100 MB per item, and available storage depends on your OneDrive account. The interface is currently in English. RelayDrop does not provide end-to-end encryption independent of Microsoft and OneDrive.

RelayDrop is an independent project and is not affiliated with or endorsed by Microsoft.
